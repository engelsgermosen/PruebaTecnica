...
{
    public class TaxPayerTypeRepository : GenericRepository<TaxPayerType, int>, ITaxPayerTypeRepository
    {
        private readonly ApplicationDbContext _context;
        public TaxPayerTypeRepository(ApplicationDbContext context) : base(context)
        {
            _context = context;
        }
    }
